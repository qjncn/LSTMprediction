...
path='F:\\BaiduNetdiskDownload\\data_new.csv'
...
def create_model(neurons=256):
   ...
   # model.add(Dropout(dropout_rate))
    ...
    #model.add(LSTM(neurons,activation='linear',return_sequences=False))
...
batch_size = [64]
epochs = [50,100,150]
param_grid = dict(batch_size=batch_size,nb_epoch=epochs,neurons=neurons)
